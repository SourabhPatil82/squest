...
AUTH_LDAP_USER_SEARCH = LDAPSearch(os.environ.get('AUTH_LDAP_USER_SEARCH', "ou=People,o=domain.com"), ldap.SCOPE_SUBTREE, "(sAMAccountName=%(user)s)")

# AUTH_LDAP_USER_SEARCH = LDAPSearch("CN=Users,DC=RPS,DC=local", ldap.SCOPE_SUBTREE, "(sAMAccountName=%(user)s)")

LDAP_CA_FILE_PATH = os.environ.get('LDAP_CA_FILE_PATH', "/usr/local/share/ca-certificates/ldap_ca.crt/ad_ca.crt")
LDAPTLS_REQCERT= os.environ.get('LDAPTLS_REQCERT', "allow")
...
AUTH_LDAP_USER_ATTR_MAP = {
    ...
    "actname": os.environ.get('AUTH_LDAP_ATTR_SAMACCOUNTNAME', 'sAMAccountName')
}